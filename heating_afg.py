...
class HotFibre():
    def __init__(self, sensor = 'TH20K', channels = [2], initial_kohms = 6.3):
        ...
        if self.sensor ==  'TH20K':
            ...
            print('TH20K sensor selected! Coeffecient is 2kohm/volt')

        elif self.sensor == 'TH200K':
            self.volt_kohm_coeff = 20
            print('TH200K sensor selected! Coeffecient is 20kohm/volt')
        ...
        for channel in channels:
            ...
            self.set_resistance_kohms(channel, initial_kohms)
    ...
    def set_resistance_kohms(self, channel, kohms):
        ...
        bytes = self.write_voltage(channel = channel, volts = volts) 
