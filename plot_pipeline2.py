...
plt.savefig('output/cross_corr_channel12_{}_bin{}_maxdelay{}.eps'.format(dossier, bins, max_delay), bbox = 'tight')
plt.xlim([-0.2, 0.2])
plt.savefig('output/cross_corr_channel12_{}_bin{}_maxdelay{}_zoomed.eps'.format(dossier, bins, max_delay), bbox = 'tight')
